...
| 軸 | 重み | 閾値 | 説明 |
|---|---|---|---|
| Functionality | high | 1.0 | 全 acceptance scenario が E2E で pass（Playwright a11y snapshot を screenshot diff より優先） |
| Craft | std | 0.7 | テスト存在、coding-rules.md 遵守、lint / 型エラーなし |
...
| Craft | std | 0.7 | エラーハンドリング、入力検証、ログ、coding-rules.md 遵守 |
...
| Craft | std | 0.7 | happy path + error path のテスト、coding-rules.md 遵守 |
