...
| Steps 7–10 | [references/installation-integration.md](references/installation-integration.md) (or `.ja.md`) — orchestration protocol; also open its step-specific secondary references before acting |
...
Read [references/installation-integration.md](references/installation-integration.md)
