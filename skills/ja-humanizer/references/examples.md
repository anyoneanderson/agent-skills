...
Source: the opening of the Zenn version (polite style) of an article about this skill, drafted with ja-humanizer, then rewritten by the writer "without compromise, down to the style". The checker reports zero at every tier for both versions; the difference lies beyond countable tells. 
...
Expected detections: zero Tier 1 in both. This pair is not a detector test; it is read as a sample to check the direction of a rewrite.
