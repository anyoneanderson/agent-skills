...
| heartbeat が未生成、worker PID が未公開、または公開済みでworkerが生存・不明、monitor が生存または不明、起動から90秒以内 | `STARTING` |
| 起動から90秒を超えて heartbeat が未生成、worker PID が未公開、または公開済みでworkerが生存・不明、monitor が生存または不明 | `DEGRADED_NO_HEARTBEAT` |
